...
namespace mc {
    ...
    public:
        ...
        static void disableAlphaTest() {
            return ((void(*)())0x03108E10)
            ();
        }

        static void enableAlphaTest() {
            return ((void(*)())0x031056BC)
            ();
        }

        static void depthFunc(int32_t i0) {
            return ((void(*)(int32_t))0x030E9BD4)
            (i0);
        }

        static void alphaFunc(int32_t i0, float32_t f0) {
            return ((void(*)(int32_t, float32_t))0x031056D8)
                (i0, f0);
        }

        static void bindTexture(int i0) {
            return ((void(*)(int))0x030E4750)
            (i0);
        }
    };
}